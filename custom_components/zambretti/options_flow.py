        ...
        options_schema = vol.Schema(
            {
                vol.Required(
                    ...
                    default=entry.options.get(
                        "wind_direction_sensor",
                        entry.data.get("wind_direction_sensor", ""),
                    ),
                ...
                vol.Required(
                    ...
                    default=entry.options.get(
                        "wind_speed_sensor_knots",
                        entry.data.get("wind_speed_sensor_knots", ""),
                    ),
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Required(
                    ...
                    default=entry.options.get(
                        "atmospheric_pressure_sensor",
                        entry.data.get("atmospheric_pressure_sensor", ""),
                    ),
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Required(
                    "temperature_sensor",
                    default=entry.options.get(
                        "temperature_sensor", entry.data.get("temperature_sensor", "")
                    ),
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Required(
                    "humidity_sensor",
                    default=entry.options.get(
                        "humidity_sensor", entry.data.get("humidity_sensor", "")
                    ),
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Required(
                    "device_tracker_home",
                    default=entry.options.get(
                        "device_tracker_home", entry.data.get("device_tracker_home", "")
                    ),
                ): selector.EntitySelector(
                ...
                vol.Required(
                    ...
                    default=str(
                        entry.options.get(
                            "update_interval_minutes",
                            entry.data.get("update_interval_minutes", "10"),
                        )
                    ),
                ...
                vol.Required(
                    ...
                    default=str(
                        entry.options.get(
                            "pressure_history_hours",
                            entry.data.get("pressure_history_hours", "3"),
                        )
                    ),
                ): selector.SelectSelector(
                    selector.SelectSelectorConfig(
                ...
                vol.Required(
                    "fog_area_type",
                    default=entry.options.get(
                        "fog_area_type", entry.data.get("fog_area_type", "normal")
                    ),
                ): selector.SelectSelector(
                    selector.SelectSelectorConfig(
                        options=[
